  ...
  public class NumberTranslation
  {
    public string Number2Words(int n)
    {
      ...
      for (int i = number.Length - 1; i >= 0; i--)
      {
        ...
        if (counter == 4 && (number.Length) < 5) a = "0";
        else if (counter == 4) a = number[i - 1].ToString();

        if (counter == 4 && numberInPosition != "0" && a != "1")
        {
          switch (numberInPosition)
          {
            case "1":
          ...
          else stringNumber = stringNumber + " thousand"; //Case: keine 1.000er bis 9999er Stellen
        }
        ...
        if (counter == 5 && numberInPosition != "0" && numberInPosition != "1")
        {
          ...
          if (number[i + 1].ToString() != "0") stringNumber = stringNumber + "-" + stringNumber1;
          else stringNumber = stringNumber + " thousand " + stringNumber1; //Case: keine 1er und 10er Stellen
        }
